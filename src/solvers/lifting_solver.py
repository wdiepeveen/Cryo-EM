...
from src.manifolds.so3 import SO3
from src.plans.lifting_plan import Lifting_Plan
from src.solvers import Joint_Volume_Rots_Solver

logger = logging.getLogger(__name__)


class Lifting_Solver(Joint_Volume_Rots_Solver):
    def __init__(self,
    ...
    def volume_step(self):
        ...
        for start in range(0, N, self.plan.rots_batch_size):
            ...
            logger.info(
                "Computing adjoint forward mappings from {} rotations at {}%".format(N,
                                                                                     int((all_idx[-1] + 1) / N * 100)))
