...
from projects.rkhs_lifting.src.plans.problems.lifting_problem2 import Lifting_Problem2
from projects.rkhs_lifting.src.plans.options.lifting_options2 import Lifting_Options2
...
class Lifting_Plan2(Plan):
    ...
    def __init__(self,
        ...
        self.p = Lifting_Problem2(images=images,
                                  filter=filter,
                                  amplitude=amplitude,
        ...
        if drs_coeffs is None:
            drs_coeffs = np.zeros(density_coeffs.shape, dtype=self.p.dtype)

        self.o = Lifting_Options2(vol=vol,
